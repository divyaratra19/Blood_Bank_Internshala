        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="code_hospital_login.php" method="POST">
                ...
                <br>
                <div class="form-group">
                  <a href="h_register.php" >New Registration</a>
                  <a href="r_login.php" class="align-self-end"  style="float:right">Login as Receiver</a>
                  <br>
